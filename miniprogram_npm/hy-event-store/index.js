...
__DEFINE__(1641952435230, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1641952435231,"./event-store":1641952435232}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1641952435231, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1641952435232, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1641952435231,"./utils":1641952435233}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1641952435233, function(require, module, exports) {
...
return __REQUIRE__(1641952435230);
})()
